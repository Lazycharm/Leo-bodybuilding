      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="group relative rounded-2xl overflow-hidden aspect-[4/3]">
            <img src={MALE_IMG} alt="Gents Section" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
              ...
              <h3 className="text-2xl md:text-3xl font-heading font-black text-foreground">
                {lang === "ar" ? "قسم الرجال" : "Men's Section"}
              </h3>
          ...
          {/* Ladies */}
          <div className="group relative rounded-2xl overflow-hidden aspect-[4/3]">
            <img src={FEMALE_IMG} alt="Ladies Section" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
              ...
              <h3 className="text-2xl md:text-3xl font-heading font-black text-foreground">
                {lang === "ar" ? "قسم السيدات" : "Women's Section"}
              </h3>
              <p className="text-muted-foreground text-sm mt-2 max-w-sm">
                {lang === "ar"
